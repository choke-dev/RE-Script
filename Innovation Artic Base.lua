...
local PumpS = CTC:NewSection("Pumps")
local ValveS = CTC:NewSection("Valves")
local FanS = CTC:NewSection("Valves")
...
ValveS:NewButton("Toggle Valve 1", "Toggles the coolant generating valves", function()
    fireclickdetector(game.Workspace.Core.Valve1.ClickDetector)
end)
ValveS:NewButton("Toggle Valve 2", "Toggles the coolant generating valves", function()
